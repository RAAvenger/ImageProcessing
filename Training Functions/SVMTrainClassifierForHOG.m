function [trainedClassifier, validationAccuracy] = SVMTrainClassifierForHOG(trainingData)
...
% Auto-generated by MATLAB on 25-Jun-2020 19:37:54
...
vn = cell(1, s(2));
for i = 1:s(2)
    vn(i) = cellstr(['column_',num2str(i)]);
end
inputTable = array2table(trainingData, 'VariableNames', vn);

predictorNames = vn(1:end-1);
predictors = inputTable(:, predictorNames);
response = inputTable(:, vn(end));
isCategoricalPredictor(1:s(2)-1) = false;
